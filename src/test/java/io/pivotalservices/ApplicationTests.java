...
import io.pivotalservices.config.GeneralConfig;
...
import static io.pivotalservices.RequestForwardingController.FORWARDED_URL;
import static io.pivotalservices.RequestForwardingController.PROXY_METADATA;
import static io.pivotalservices.RequestForwardingController.PROXY_SIGNATURE;
...
public class ApplicationTests {
	...
	public static class TestConfig {
		...
		@Bean
		public RequestForwardingController requestForwardingController(RestTemplate restTemplate) {
			return new RequestForwardingController(restTemplate);
		}
	}
}
